...
`cross_attention_masks/Scene7playing/seed42/lambda_lre=0` 在 2026-08-03 06:19 达到
精确 20k，其余六条保持精确 10k continuation。GPU 所有权 watchdog 与污染恢复
...
| P3 30k / causal / seeds | 1/8 完整验证；第二条精确 20k；其余六条精确 10k | 依门禁顺序继续 |
...
生成器在 commit `ab184f9` 完成 finalist/no-finalist 双分支闭环，并在 commit
`9fa1302` 增加模型训练证据与 Source/Mono 原始参考产物的严格复核。最新全量 pytest
438/438 通过。正式内容寻址产物为：
...
`/tmp`。Audio-only relay 完成后，冻结于 `9fa13023dea1048e4955236b724d5abd12698e81`
的报告 worktree 自动生成：
...
报告 worktree commit `9fa13023dea1048e4955236b724d5abd12698e81` 与生成器 SHA-256
`cf3b7e79b568062963b13d839dba1a19c82a07b501fe060c7e0e4a5f9951aff6`，并在等待
上游时校验 PID 命令身份。
...
目录残留解释为阶段成功。
该链路冻结于工具提交 `2fc0353258450831b62fcd0538b2e1ed22786675`，并完整固定
adaptive runner 的 relocated runner、watchdog、shard generator 与 main/causal verifier
传递依赖。替换只终止旧的
